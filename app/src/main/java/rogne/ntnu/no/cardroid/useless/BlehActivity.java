...
public class BlehActivity extends AppCompatActivity {
    ...
    public void onClick() {
        pfd = ParcelFileDescriptor.fromSocket(getConnection());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextureView = (TextureView) findViewById(R.id.Bleh);
        mButtonVideo = ((Button)findViewById(R.id.BlehBtn));
        mButtonVideo.setOnClickListener(c->onClick());
